...
Executing this command will launch the Raspirus application.
Congratulations! You have now completed the installation process and can begin using the Raspirus app.
